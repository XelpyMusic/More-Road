...
public class FlecheBlock extends MoreRoadModElements.ModElement {
	@ObjectHolder("more_road:fleche")
	public static final Block block = null;
	public FlecheBlock(MoreRoadModElements instance) {
		super(instance, 14);
	}
