...
public class BitumeBlock extends MoreRoadModElements.ModElement {
	@ObjectHolder("more_road:bitume")
	public static final Block block = null;
	public BitumeBlock(MoreRoadModElements instance) {
		super(instance, 9);
	}
