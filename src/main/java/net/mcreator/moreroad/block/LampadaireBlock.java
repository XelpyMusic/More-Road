...
public class LampadaireBlock extends MoreRoadModElements.ModElement {
	@ObjectHolder("more_road:lampadaire")
	public static final Block block = null;
	public LampadaireBlock(MoreRoadModElements instance) {
		super(instance, 12);
	}
