...
public class FeuTricoloreBlock extends MoreRoadModElements.ModElement {
	@ObjectHolder("more_road:feu_tricolore")
	public static final Block block = null;
	public FeuTricoloreBlock(MoreRoadModElements instance) {
		super(instance, 11);
	}
