...
public class PoteauBlock extends MoreRoadModElements.ModElement {
	@ObjectHolder("more_road:poteau")
	public static final Block block = null;
	public PoteauBlock(MoreRoadModElements instance) {
		super(instance, 2);
	}
